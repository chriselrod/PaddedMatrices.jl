function _precompile_()
    ...
    precompile(Tuple{typeof(Base.cat_similar),DynamicPaddedArray{Float64,3},Type{T} where T,Tuple{Int64,Int64,Int64}})
    precompile(Tuple{typeof(PaddedMatrices.K_unknown_At_mul_X_quote),Type{T} where T,Type{T} where T,Int64,Int64,Type{T} where T,Int64,Bool,Symbol,Symbol,Symbol,Bool})
    precompile(Tuple{typeof(PaddedMatrices.generalized_getindex_quote),Core.SimpleVector,Core.SimpleVector,Type{T} where T,Any,Bool,Bool})
    precompile(Tuple{typeof(PaddedMatrices.init_mutable_fs_padded_array_quote),Core.SimpleVector,Type{T} where T})
    precompile(Tuple{typeof(PaddedMatrices.mulquote),Int64,Int64,Int64,Int64,Int64,Type{Float64},Symbol,Nothing,Int64})
    precompile(Tuple{typeof(PaddedMatrices.rand_iter_expr),Type{T} where T,Int64,Int64,Expr,Int64,Int64})
    precompile(Tuple{typeof(PaddedMatrices.rand_mutable_fixed_size_expr),Int64,Type{T} where T,Int64,Symbol,Int64,Int64,Symbol,Vararg{Symbol,N} where N})
    precompile(Tuple{typeof(PaddedMatrices.rand_mutable_fixed_size_expr),Int64,Type{T} where T,Int64,Symbol,Int64})
