function _precompile_()
    ...
    precompile(Tuple{Core.kwftype(typeof(PaddedMatrices.Type)),NamedTuple{(:X_transposed, :negative),Tuple{Bool,Bool}},Type{PaddedMatrices.DynamicKernel},Int64,Int64,Int64,Int64,Int64,Int64,DataType})
    precompile(Tuple{Core.kwftype(typeof(PaddedMatrices.mul_tn_quote)),NamedTuple{(:negative, :force_inline),Tuple{Bool,Bool}},typeof(PaddedMatrices.mul_tn_quote),Int64,Int64,Int64,Type,Bool,Int64,Int64,Int64})
    precompile(Tuple{Core.kwftype(typeof(PaddedMatrices.mul_tn_quote)),NamedTuple{(:negative, :force_inline),Tuple{Bool,Bool}},typeof(PaddedMatrices.mul_tn_quote),Int64,Symbol,Int64,Type,Bool,Symbol,Symbol,Int64})
    ...
    precompile(Tuple{typeof(PaddedMatrices.gemminit),PaddedMatrices.DynamicKernel,UInt8,Bool,Bool})
