...
@inline PtrArray{S,T,N,X}(ptr, st::NTuple{SN,Int}, xt::NTuple{XN,Int}) where {S,T,N,X,SN,XN} = PtrArray{S,T,N,X,SN,XN,true}(ptr, st, xt)
@inline FixedSizeArray{S,T,N,X}(ptr, st::NTuple{SN,Int}, xt::NTuple{XN,Int}, d::Base.RefValue{NTuple{L,T}}) where {S,T,N,X,L,SN,XN} = FixedSizeArray{S,T,N,X,L,SN,XN,true}(ptr, st, xt,d)
@inline StrideArray{S,T,N,X}(ptr, st::NTuple{SN,Int}, xt::NTuple{XN,Int},data) where {S,T,N,X,SN,XN} = StrideArray{S,T,N,X,SN,XN,true}(ptr, st, xt, data)
